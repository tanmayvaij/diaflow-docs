...
const DiaFlowDocs = () => {
  ...
  const CodeBlock = ({ children, language = 'typescript', id }) => (
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-1">
              <NavItem isActive={activeSection === 'home'} onClick={() => scrollToSection('home')}>
                Home
              </NavItem>
              <NavItem isActive={activeSection === 'features'} onClick={() => scrollToSection('features')}>
                Features
              </NavItem>
              <NavItem isActive={activeSection === 'quickstart'} onClick={() => scrollToSection('quickstart')}>
                Quick Start
              </NavItem>
              <NavItem isActive={activeSection === 'docs'} onClick={() => scrollToSection('docs')}>
                Docs
              </NavItem>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
                A lightweight AI agent framework built on Google GenAI. Create tool-using agents with memory 
                and structured JSON outputs powered by Zod. Think LangChain, but simpler.
              </p>
            ...
            <div className="mt-20 max-w-4xl mx-auto">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-slate-800 mb-2">Quick Example</h2>
                <p className="text-slate-600">Get started with DiaFlow in just a few lines of code</p>
              </div>
...
console.log(result);`}
        ...
        {/* Quick Start Section */}
        <section id="quickstart" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-indigo-50">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <p className="text-slate-600 mb-4">Install DiaFlow using npm or yarn:</p>
...
(async () => {
  ...
  console.log(result);
              ...
              <div>
                ...
                <p className="text-slate-600 mb-4">Define tools that your AI agent can use:</p>
...
export const tools: Tool[] = [
  {
    ...
    handler: ({ filePath }: { filePath: string }) => {
      ...
      return { success: true, message: \`Created at \${filePath}\` };
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4 flex items-center">
                  <span className="bg-indigo-100 text-indigo-600 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3">4</span>
                  Using Memory
                </h3>
                
                <p className="text-slate-600 mb-4">Maintain conversation context with memory:</p>
...
console.log(memory.getContent());`}
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Next Steps:</strong> Check out the full documentation to learn about advanced features like graph-like execution, custom configurations, and more complex tool integrations.
                </AlertDescription>
              </Alert>
            </div>
          </div>
        ...
        <section id="docs" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800">API Reference</h3>
                </div>
                <p className="text-slate-600 mb-4">
                  Complete API documentation with all available methods, parameters, and examples.
                </p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800">Guides & Tutorials</h3>
                </div>
                <p className="text-slate-600 mb-4">
                  Step-by-step guides to help you build complex AI agent workflows.
                </p>
                <div className="space-y-2 text-sm">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800">Examples</h3>
                </div>
                <p className="text-slate-600 mb-4">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-800">Community</h3>
                </div>
                <p className="text-slate-600 mb-4">
            ...
            {/* Key Concepts */}
            <div>
              <h3 className="text-2xl font-bold text-slate-800 mb-8 text-center">Key Concepts</h3>
              
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
                  <h4 className="text-xl font-semibold text-slate-800 mb-3">Agents</h4>
                  <p className="text-slate-600 mb-4">
                    The core component of DiaFlow. Agents orchestrate the interaction between the AI model, tools, and memory systems.
                  </p>
...
{`const agent = new Agent({
  ...
  responseJsonSchema: schema, // Optional Zod schema for structured output
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
                  <h4 className="text-xl font-semibold text-slate-800 mb-3">Graph-Like Execution</h4>
                  <p className="text-slate-600 mb-4">
                    Chain multiple agents together to create complex workflows with branching, sequencing, or parallel execution.
                  </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-slate-400 mb-4 max-w-md">
                A lightweight AI agent framework built on Google GenAI. Create tool-using agents with memory and structured outputs.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><button onClick={() => scrollToSection('quickstart')} className="hover:text-white transition-colors">Quick Start</button></li>
                <li><button onClick={() => scrollToSection('docs')} className="hover:text-white transition-colors">API Reference</button></li>
                <li><a href="https://github.com/tanmayvaij/diaflow#examples" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Examples</a></li>
                <li><button onClick={() => scrollToSection('docs')} className="hover:text-white transition-colors">Guides</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><a href="https://github.com/tanmayvaij/diaflow" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a></li>
                <li><a href="https://github.com/tanmayvaij/diaflow/issues" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Issues</a></li>
                <li><a href="https://github.com/tanmayvaij/diaflow/discussions" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Discussions</a></li>
                <li><a href="https://github.com/tanmayvaij/diaflow/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Contributing</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              MIT © 2025 <a href="https://github.com/tanmayvaij" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Tanmay Vaij</a>
            </p>
